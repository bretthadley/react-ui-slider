...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactUISlider = __webpack_require__(84);
	...
	var Demo = function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_ReactUISlider2.default, sliderProps);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (e, t) {
		if ("object" == ( false ? "undefined" : _typeof(exports)) && "object" == ( false ? "undefined" : _typeof(module))) module.exports = t(__webpack_require__(51));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(51)], __WEBPACK_AMD_DEFINE_FACTORY__ = (t), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else {
			var a = t("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? require("react") : e.React);for (var n in a) {
				("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports : e)[n] = a[n];
			}
		}
		...
		return function (e) {
			...
			function n(e) {
			    ...
			    c = function (e) {
				function t() {
					var e, a, n, r;s(this, t);for (var o = arguments.length, l = Array(o), u = 0; o > u; u++) {
						l[u] = arguments[u];
					}return a = n = i(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(l))), n.state = { index: -1, upperBound: 0, sliderLength: 0, sliderStart: 0 }, n._handleResize = function () {
						var e = n.refs.slider,
						    t = n.refs.handle;if (e) {
							var a = e.getBoundingClientRect(),
							    r = n._sizeKey(),
							    s = a[n._stylePositionMaxOffset()],
							    i = a[n._stylePositionMinOffset()];n.setState({ upperBound: e[r] - t[r], sliderLength: Math.abs(s - i), handleSize: t[r], sliderStart: i });
						} else n.forceUpdate();
					}, n._calcOffsetFromPosition = function (e) {
						var t = e - n.state.sliderStart;return t -= n.state.handleSize / 2;
					}, n._forceValueFromPosition = function (e) {
						var t = n._calcOffsetFromPosition(e),
						    a = n._trimAlignValue(n._calcValue(t));n.setState({ value: a, enteredValue: a });
					}, n._getMousePosition = function (e) {
						return [e["page" + n._axisKey()], e["page" + n._orthogonalAxisKey()]];
					}, n._getTouchPosition = function (e) {
						var t = e.touches[0];return [t["page" + n._axisKey()], t["page" + n._orthogonalAxisKey()]];
					}, n._getMouseEventMap = function () {
						return { mousemove: n._onMouseMove, mouseup: n._onMouseUp };
					}, n._getTouchEventMap = function () {
						return { touchmove: n._onTouchMove, touchend: n._onTouchEnd };
					}, n._createMouseEvent = function (e) {
						if (!n.props.disabled) {
							var t = n._getMousePosition(e);n._start(t[0]), n._addHandlers(n._getMouseEventMap()), e.preventDefault();
						}
					}, n._createOnTouchStart = function (e) {
						if (!(n.props.disabled || e.touches.length > 1)) {
							var t = n._getTouchPosition(e);n.isScrolling = void 0, n._start(t[0]), n._addHandlers(n._getTouchEventMap()), e.stopPropagation();
						}
					}, n._addHandlers = function (e) {
						for (var t in e) {
							e.hasOwnProperty(t) && document.addEventListener(t, e[t], !1);
						}
					}, n._start = function (e) {
						document.activeElement && document.activeElement != document.body && document.activeElement.blur(), n.hasMoved = !1, n._fireChangeEvent("onBeforeChange"), n.setState({ startValue: n.state.value, startPosition: e });
					}, n._onMouseUp = function () {
						n._onEnd(n._getMouseEventMap()), n._fireChangeEvent("onSliderRelease");
					}, n._onTouchEnd = function () {
						n._onEnd(n._getTouchEventMap()), n._fireChangeEvent("onSliderRelease");
					}, n._onEnd = function (e) {
						n._removeHandlers(e), n._fireChangeEvent("onAfterChange");
					}, n._onMouseMove = function (e) {
						var t = n._getMousePosition(e);n._move(t[0]);
					}, n._onTouchMove = function (e) {
						if (!(e.touches.length > 1)) {
							var t = n._getTouchPosition(e);if ("undefined" == typeof n.isScrolling) {
								var a = t[0] - n.state.startPosition[0],
								    r = t[1] - n.state.startPosition[1];n.isScrolling = Math.abs(r) > Math.abs(a);
							}if (n.isScrolling) return void n.setState({ index: -1 });e.preventDefault(), n._move(t[0]);
						}
					}, n._onSliderClick = function (e) {
						e.preventDefault(), n._fireChangeEvent("onSliderClick");
					}, n._onSliderMouseDown = function (e) {
						if (!n.props.disabled) {
							if (n.hasMoved = !1, !n.props.snapDragDisabled) {
								var t = n._getMousePosition(e);n._forceValueFromPosition(t[0]), n._start(t[0]), n._addHandlers(n._getMouseEventMap());
							}e.preventDefault();
						}
					}, n._onInputChange = function (e) {
						var t = e.target.value;n.setState({ enteredValue: t });
					}, n._onInputBlur = function (e) {
						var t = void 0;t = e.target.value ? n.state.enteredValue : n.state.value, t = n._trimValue(parseInt(t, 10));var a = n.refs.input.getDOMNode();a.value = t, n.setState({ value: t, enteredValue: t }), n.props.onInputChange && n.props.onInputChange(t);
					}, n._onInputFocus = function () {
						var e = n.refs.input.getDOMNode();e.value = "";
					}, n._onKeyUp = function (e) {
						var t = 13;e.which === t && n._onInputBlur(e);
					}, n._renderBar = function (e, t, a) {
						var r = {};r[n.props.barClassName] = !0, r[n.props.barClassName + "-" + e] = !0;var s = (0, d["default"])(r),
						    i = n._buildBarStyle(t, a);return p["default"].createElement("div", { key: "bar" + e, ref: "bar" + e, className: s, style: i });
					}, n._renderBars = function () {
						var e = n._calcOffset(),
						    t = [];return t.push(n._renderBar(0, 0, e)), t.push(n._renderBar(1, e, 100)), t;
					}, r = a, i(n, r);
				}return o(t, e), l(t, [{ key: "componentWillReceiveProps", value: function value(e) {
					...
					} }, { key: "_calcOffset", value: function value(e) {
						var t = e || this.state.value,
						    a = (t - this.props.min) / (this.props.max - this.props.min);return 100 * a;
						...
						this.hasMoved = !0;var t = e - this.state.startPosition,
						    a = t / (this.state.sliderLength - this.state.handleSize) * (this.props.max - this.props.min),
						    n = this._trimAlignValue(this.state.startValue + a);n !== this.state.value && this.setState({ value: n, enteredValue: n }, this._fireChangeEvent("onChange"));
						...
						var t = arguments.length <= 1 || void 0 === arguments[1] ? this.props : arguments[1],
						    a = e;return a < t.min && (a = t.min), a > t.max && (a = t.max), a;
					} }, { key: "_alignValue", value: function value(e) {
						if (Array.isArray(this.props.step)) {
							var t = Math.abs(this._calcOffset(e)),
							    a = this.props.step.length,
							    n = a / 100,
							    r = a / (100 + n) * t,
							    s = Math.round(r);return s >= a && (s = a - 1), 0 > s && (s = 0), this.props.step[s];
						}var i = (e - this.props.min) % this.props.step,
						    o = e - i;return 2 * Math.abs(i) >= this.props.step && (o += i > 0 ? this.props.step : -this.props.step), o + this.props.step > this.props.max && (o = this.props.max), parseFloat(o.toFixed(5));
						...
						var a = { position: "absolute" },
						    n = isNaN(e) ? 0 : e,
						    r = isNaN(t) ? 0 : t;return a[this._stylePositionMinOffset()] = n + "%", a[this._stylePositionMaxOffset()] = 100 - r + "%", a;
					} }, { key: "_renderHandle", value: function value() {
						var e = this._calcOffset(),
						    t = {};t[this.props.handleClassName] = !0;var a = (0, d["default"])(t),
						    n = this._buildHandleStyle(e);return p["default"].createElement("div", { key: "handle", ref: "handle", className: a, style: n, onMouseUp: this._createMouseEvent, onTouchStart: this._createOnTouchStart, role: "slider", "aria-valuemin": this.props.min, "aria-valuemax": this.props.max, "aria-valuenow": this.props.value, "aria-labelledby": this.props.labelClassName });
					} }, { key: "_renderInputOutput", value: function value() {
						var e = this.props.label ? p["default"].createElement("span", { className: this.props.labelClassName }, this.props.label) : null,
						    t = this.props.labelSmall ? p["default"].createElement("span", { className: "slider__label--small" }, p["default"].createElement("small", null, this.props.labelSmall)) : null,
						    a = this.props.valuePrefix ? p["default"].createElement("span", { className: "slider__value--prefix" }, this.props.valuePrefix) : null,
						    n = this.props.valueSuffix ? p["default"].createElement("span", { className: "slider__value--suffix" }, this.props.valueSuffix) : null;return this.props.editable ? p["default"].createElement("div", { className: this.props.inputClassName }, e, p["default"].createElement("div", { className: "slider__value-prefix-suffix" }, a, p["default"].createElement("input", { className: "slider__value", value: this.state.enteredValue, type: "number", ref: "input", min: this.props.min, max: this.props.max, onChange: this._onInputChange, onFocus: this._onInputFocus, onBlur: this._onInputBlur, onKeyUp: this._onKeyUp }), n), t) : p["default"].createElement("div", { className: this.props.outputClassName }, e, p["default"].createElement("div", { className: "slider__value-prefix-suffix" }, a, p["default"].createElement("span", { className: "slider__value" }, this.state.value, n)), t);
					} }, { key: "render", value: function value() {
						var e,
						    t = this._renderBars(),
						    a = this._renderHandle(),
						    n = this._renderInputOutput(),
						    s = (0, d["default"])((e = {}, r(e, this.props.className, !0), r(e, "disabled", this.props.disabled), e));return p["default"].createElement("div", { className: this.props.containerClassName }, n, p["default"].createElement("div", { className: "slider__holder" }, p["default"].createElement("div", { className: s, ref: "slider", onMouseDown: this._onSliderMouseDown, onClick: this._onSliderClick }, t, a)));
					} }]), t;
			}(p["default"].Component);c.propTypes = { min: p["default"].PropTypes.number, max: p["default"].PropTypes.number, step: p["default"].PropTypes.oneOfType([p["default"].PropTypes.number, p["default"].PropTypes.arrayOf(p["default"].PropTypes.number)]).isRequired, defaultValue: p["default"].PropTypes.number, value: p["default"].PropTypes.number, valuePrefix: p["default"].PropTypes.string, valueSuffix: p["default"].PropTypes.string, orientation: p["default"].PropTypes.oneOf(["horizontal", "vertical"]), editable: p["default"].PropTypes.bool, className: p["default"].PropTypes.string, containerClassName: p["default"].PropTypes.string, inputClassName: p["default"].PropTypes.string, outputClassName: p["default"].PropTypes.string, handleClassName: p["default"].PropTypes.string, handleActiveClassName: p["default"].PropTypes.string, barClassName: p["default"].PropTypes.string, disabled: p["default"].PropTypes.bool, snapDragDisabled: p["default"].PropTypes.bool, onBeforeChange: p["default"].PropTypes.func, onChange: p["default"].PropTypes.func, onAfterChange: p["default"].PropTypes.func, onSliderClick: p["default"].PropTypes.func, onInputChange: p["default"].PropTypes.func, onSliderRelease: p["default"].PropTypes.func }, c.defaultProps = { min: 0, max: 100, defaultValue: 0, orientation: "horizontal", containerClassName: "slider__container", className: "slider", handleClassName: "slider__handle", handleActiveClassName: "slider__handle--active", inputClassName: "slider__input", outputClassName: "slider__output", barClassName: "slider__bar", labelClassName: "slider__label", valuePrefix: null, valueSuffix: null, disabled: !1, snapDragDisabled: !1, invert: !1, editable: !1 }, t["default"] = c;
		}, function (e, t, a) {
			var n, r; /*!
				...
				function a() {
					for (var e = [], t = 0; t < arguments.length; t++) {
						var n = arguments[t];if (n) {
							var r = typeof n === "undefined" ? "undefined" : _typeof(n);if ("string" === r || "number" === r) e.push(n);else if (Array.isArray(n)) e.push(a.apply(null, n));else if ("object" === r) for (var i in n) {
								s.call(n, i) && n[i] && e.push(i);
							}
						}
					}return e.join(" ");
				}var s = {}.hasOwnProperty;"undefined" != typeof e && e.exports ? e.exports = a : (n = [], r = function () {
					return a;
